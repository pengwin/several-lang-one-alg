import { QSortNodesSorting } from '../src/QSortNodesSorting';
import { Node } from '../src/Node';
import { Path } from '../src/Path';

test('WithoutPath_WithoutCollision', () => {
    // arrange
    var sorting = new QSortNodesSorting(null, 4);
...
test('WithPath_WithoutCollision', () => {
    // arrange
    var path = new Path(4);
    var sorting = new QSortNodesSorting(path, 4);
    var nodes: Array<Node> = [];
...
test('WithPath_WithCollision_onAllItems', () => {
    // arrange
    var path = new Path(9);
    var sorting = new QSortNodesSorting(path, 9);
    var nodes: Array<Node> = [];
