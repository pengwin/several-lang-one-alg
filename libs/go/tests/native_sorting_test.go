...
func TestNativeSorting_WithoutPath_WithoutCollision(t *testing.T) {

	// arrange
	var sorting = sums.NewNodesSortingNative(nil, 4)
...
func TestNativeSorting_WithPath_WithoutCollision(t *testing.T) {

	// arrange
	var path = sums.NewPath(4)
	var sorting = sums.NewNodesSortingNative(path, 4)
	var nodes = make([]*sums.Node, 2)
...
func TestNativeSorting_WithPath_WithCollision_onAllItems(t *testing.T) {

	// arrange
	var path = sums.NewPath(9)
	var sorting = sums.NewNodesSortingNative(path, 9)
...
func TestNativeSorting_WithPath_WithCollision_OnTwoItems(t *testing.T) {
...
func TestNativeSorting_WithoutPath_WitCollision(t *testing.T) {
...
func TestNativeSorting_WithoutPath_WitCollision_SetFirst(t *testing.T) {
